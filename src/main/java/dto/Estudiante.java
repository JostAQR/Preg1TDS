...
public class Estudiante implements Serializable {
    ...
    public Estudiante(Integer codiEstdWeb, String ndniEstdWeb, String appaEstdWeb, String apmaEstdWeb, String nombEstdWeb, Date fechNaciEstdWeb, String logiEstd, String passEstd) {
        this.codiEstdWeb = codiEstdWeb;
    ...
    public String toString() {
        return "dao.Estudiante[ codiEstdWeb=" + codiEstdWeb + " ]";
    }
