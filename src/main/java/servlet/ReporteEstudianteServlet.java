 ...
 * @author Quichiz
 */
@WebServlet(name = "ReporteEstudianteServlet", urlPatterns = {"/ReporteEstudianteServlet"})
public class ReporteEstudianteServlet extends HttpServlet {

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // Ruta del archivo .jasper compilado
            String pathJasper = getServletContext().getRealPath("/reporte/reportEstu.jasper");
